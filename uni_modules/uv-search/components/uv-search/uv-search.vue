...
<script>
	 ...
	 * @property {String}			searchIcon			输入框左边的图标，可以为uvui图标名称或图片路径  (默认 'searchGame' )
	 ...
	 * @event {Function} searchGame 用户确定搜索时触发，用户按回车键，或者手机键盘右下角的"搜索"键时触发
	 * @event {Function} custom 用户点击右侧控件时触发
	 * @event {Function} clear 用户点击清除按钮时触发
	 * @example <uv-searchGame placeholder="日照香炉生紫烟" v-model="keyword"></uv-searchGame>
	 */
	export default {
		name: "uv-search",
